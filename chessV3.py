...
def redrawBoard():
 ...
 while y<canvasHeight:
  canvasBoard.create_line(0, y, canvasWidth, y, fill="white")
#  canvasBoard.create_rectangle(0,y,80,80,fill="white")
  y=y+80

 x=0
 while x<=canvasWidth:
  canvasBoard.create_line(x, 0, x, canvasHeight, fill="white")
...
def highlightSquare(xcor,ycor,colorName):
 canvasBoard.create_line(xcor*80, ycor*80,xcor*80,ycor*80+80, fill=colorName)
 canvasBoard.create_line(xcor*80, ycor*80,xcor*80+80,ycor*80, fill=colorName)
 canvasBoard.create_line(xcor*80, ycor*80+80,xcor*80+80,ycor*80+80, fill=colorName)
 canvasBoard.create_line(xcor*80+80, ycor*80,xcor*80+80,ycor*80+80, fill=colorName)
...
canvasWidth = 640
canvasHeight = 640
canvasBoard = Canvas(master,width=canvasWidth,height=canvasHeight)
canvasBoard.pack()
